...
const DetailUserComponent = ({ visible, productDetail, setVisible }) => {
    const [productData, setProductInfoData] = useState({})

    useEffect(() => {
        setProductInfoData(productDetail)
    }, [productDetail])
    const handleCancel = () => {
